<?php
	...
	$video_style = get_post_meta($id , 'video_style', TRUE) ? get_post_meta($id , 'video_style', TRUE) : 'light';
...
<?php if (have_posts()) :  while (have_posts()) : the_post(); ?>
	<div class="container inner">
		...
		<div class="main-content single-style-1 single-video-style-1 <?php echo esc_attr($wide_sidebar);?> <?php  echo esc_attr($video_style); ?> col-xs-12">
