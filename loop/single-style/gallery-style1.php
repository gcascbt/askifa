...
<?php if (have_posts()) :  while (have_posts()) : the_post(); ?>
	...
	<div class="container inner-single">
		<div class="row">
			<div class="single-style-1 single-gallery-style-2">
								...
								if ( function_exists( 'ot_get_option' ) ) {
										...
										if ( ! empty( $images ) ) {
											foreach( $images as $id ) {
												if ( ! empty( $id ) ) {
													$full_img_src = wp_get_attachment_image_src( $id, 'cairo-post-large-one' );
													echo '<li><img src="'. esc_url($full_img_src[0]).'"></li>';
												}
											}
										}
									}
