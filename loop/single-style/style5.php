...
<?php if (have_posts()) :  while (have_posts()) : the_post(); ?>
	<div class="container inner-single">
		...
		<div class="row">
			...
			<article <?php post_class('page-post post single-style-5'); ?> id="post-<?php the_ID(); ?>" itemscope itemtype="http://schema.org/Article" role="article" >
				<?php $thumb = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'full' );?>
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="header-single-post page-post">
						...
						<div class="post-share-info visible-sm visible-xs">
				...
				<div class="post-style-main-content col-md-12 col-sm-12 col-xs-12">
					<div class="single-share-left visible-lg visible-md">
						<?php if($cairo_author_meta_enable =='on'):?>
						<div class="author-info-small text-left pull-left">
							<aside class="post-author">
								<?php echo get_avatar( get_the_author_meta( 'ID' ), 50 ); ?>
