...
<?php if (have_posts()) :  while (have_posts()) : the_post(); ?>
	...
	<div class="page-post post single-style-7 single-post-top">
		<?php $thumb = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'full' );?>
		<figure class="post-image parallax" style="background-image: url('<?php echo esc_url($thumb['0']);?>')"></figure>
	...
	<div class="container inner-single">
		...
		<div class="main-content <?php echo esc_attr($wide_sidebar);?> col-xs-12">
