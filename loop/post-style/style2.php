<?php
cairo_get_post_views($post->ID);
$views = cairo_get_post_views(get_the_ID());
?>
<div class="col-md-6 col-sm-6 col-xs-12">
	<article itemscope itemtype="http://schema.org/Article" <?php post_class('post status-publish post-style2'); ?> role="article">
		...
		<div class="post-content">
			...
			<div class="post-excerpt">
				<p><?php echo cairo_string_limit_words(get_the_excerpt(), 20);?>&hellip;</p>
			</div> <!-- post-entry -->
		</div><!-- post-content -->
	</article><!-- post -->
</div>
