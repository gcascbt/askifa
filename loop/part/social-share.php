...
if ( ! function_exists( 'cairo_social_single_top' ) ) :
	function cairo_social_single_top() {
		...
		$socials = apply_filters( 'cairo_social_single_top', $socials ); ?>
			<div class="social-share-button">
				...
				<?php if ( in_array( 'linkedin', $socials ) ) : ?>
					<li><a class="linkedin" href="https://www.linkedin.com/countserv/count/share?format=json&url=<?php the_permalink(); ?>" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
				<?php endif; ?>
				</ul>
			</div>
<?php } endif;
...
if ( ! function_exists( 'cairo_social_single_bottom' ) ) :
	function cairo_social_single_bottom() {
		...
		$socials = apply_filters( 'cairo_social_single_bottom', $socials ); ?>
