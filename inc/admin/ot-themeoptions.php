...
function custom_theme_options() {
  ...
  $custom_settings = array(
    ...
    'sections'        => array(
      ...
      array(
        'title'       => '<i class="ti ti-layout-slider-alt"></i> '.esc_html__( 'AMP', 'cairo' ),
        'id'          => 'amp'
      ),
      array(
    ...
    'settings'        => array(
          ...
          array(
            ...
            'id'          => 'post_view_count',
            'type'        => 'on_off',
            'desc'        => 'Enabled or Disabled Post View Count.',
            'std'         => 'on',
            'section'     => 'general'
          ),
          //HEADER SETTINGS
          ...
          array(
            'label'       => 'Login Icon ON/OFF',
            'id'          => 'login_icon_hide_show',
            'type'        => 'on_off',
            'desc'        => 'Enabled or Disabled Login Icon in header.',
            'std'         => 'on',
            'section'     => 'header'
          ),
          array(
          ...
          array(
            'label'       => 'Mobile Logo ON/OFF',
            'id'          => 'mobile_logo_hide_show',
            'type'        => 'on_off',
            'desc'        => 'Enabled or Disabled Mobile Logo.',
            'std'         => 'on',
            'section'     => 'header'
          ),
          array(
            ...
            'desc'        => 'You can upload your own logo here. Since this theme is retina-ready, <strong>please upload a double size image.</strong>',
            'section'     => 'header',
            'condition'   => 'mobile_logo_hide_show:is(on)'
          ),
          array(
            'label'       => 'Search Area Logo ON/OFF',
            'id'          => 'search_area_logo_hide_show',
            'type'        => 'on_off',
            'desc'        => 'Enabled or Disabled Search Area Logo.',
            'std'         => 'on',
            'section'     => 'header'
          ),
          array(
            ...
            'desc'        => 'You can upload your own logo here. Since this theme is retina-ready, <strong>please upload a double size image.</strong>',
            'section'     => 'header',
            'condition'   => 'search_area_logo_hide_show:is(on)'
          ),
          array(
          ...
          array(
            ...
            'id'        => 'amp_on_off',
            'type'      => 'on_off',
            'desc'      => 'You can Enable or Disabled AMP',
            'std'       => 'off',
            'section'   => 'amp'
          ),
          array(
            ...
            'section'     => 'amp',
            'std'         => CAIRO_URL . 'assets/images/logo/cairo-logo.png',
            'condition'   => 'amp_on_off:is(on)',
          ),
          array(
            'label'     => 'Enable Share Icons',
            'id'        => 'shareicons_on_off',
            'type'      => 'on_off',
            'desc'      => 'You can Enable or Disabled Share Icons',
            'std'       => 'off',
            'section'   => 'amp',
            'condition'   => 'amp_on_off:is(on)',
          ),
          ...
          array(
            ...
            'label'       => 'Header Background Theme Color',
            'type'        => 'colorpicker',
            'section'     => 'amp',
          ),
          array(
          ...
          array(
            'id'          => 'amp_links_color',
            'desc'        => 'Links Color',
            'label'       => 'Links Theme Color',
            'type'        => 'colorpicker',
            'section'     => 'amp',
          ),
          array(
            'id'          => 'amp_postmeta_color',
            'desc'        => 'Post Meta Color',
            'label'       => 'Post Meta Theme Color',
            'type'        => 'colorpicker',
            'section'     => 'amp',
          ),
          array(
