...
function cairo_radio_images( $array, $field_id ) {
  ...
  if ( $field_id == 'gallery-post-detail-style' ) {
    ...
    $array = array(
      ...
      array(
        'value'   => 'style4',
        'label'   => esc_html__( 'Footer Style 4', 'cairo' ),
        'src'     => CAIRO_URL . 'assets/images/admin/footer_column/cairo_footer_style4.png'
      ),
    );
	}
    ...
    $array = array(
      ...
      array(
        'value'   => 'style6',
        'label'   => esc_html__( 'Header Style 6', 'cairo' ),
				'src'     => CAIRO_URL . '/assets/images/admin/header_style/cairo_header_style_6.png'
      ),
    );
	}
