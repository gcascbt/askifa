...
$codepagesthemes_url = 'http://code-pages.com';
?>
	...
	<div class="codepagesthemes-support-wrapper clearfix">
    	<div class="features-section three-col">
        	<div class="feature-item col">
                ...
                <?php printf( '<a href="%s" class="button button-large button-primary btn-lg-button" target="_blank">%s</a>', 'mailto:codeofpage@gmail.com', esc_html__( "Submit A Ticket", "cairo" ) ); ?>
            </div>
            <div class="feature-item col">
                ...
                <?php printf( '<a href="%s" class="button button-large button-primary btn-lg-button" target="_blank">%s</a>', $codepagesthemes_url . '/cairo/docs/', esc_html__( "Documentation", "cairo" ) ); ?>
            </div>
